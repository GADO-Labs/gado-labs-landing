...
- When you change category **`minScore`** values in [`.github/lighthouse/lighthouserc.json`](.github/lighthouse/lighthouserc.json), update the **Category score floors** bullet under **Continuous integration (Lighthouse)** here and in GEMINI.md so the quick-reference numbers stay accurate.
